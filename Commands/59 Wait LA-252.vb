<Command("Wait LA-252", "Mixer Time |60-999| Type |0-1| Qty% |0-100|", , , "15+('1/60)", CommandType.Standard), _
TranslateCommand("zh-TW", "等待染料備藥", "攪拌時間 |60-999| 水源 |0-1| 水量% |0-100|"), _
...
Public NotInheritable Class Command59
  ...
  Public Function Start(ByVal ParamArray param() As Integer) As Boolean Implements ACCommand.Start
    With ControlCode
      ...
      .Command10.Cancel() : .Command61.Cancel() : .Command01.Cancel()
...
Partial Public Class ControlCode
  Public ReadOnly Command59 As New Command59(Me)
End Class
